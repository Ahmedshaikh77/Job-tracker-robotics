...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Applicants must not need sponsorship now or in the future.",
        "Candidates must work without the need for sponsorship.",
        "This position is not eligible for visa sponsorship.",
        "This role is not eligible for employment-based immigration sponsorship.",
        "Employment-based immigration sponsorship is not eligible for this role.",
        ...
        "Applicants must be green card holders.",
        "Green card holders",
    ],
)
